<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <!-- <li class="menu-item active">
            <a href="javascript:void(0);" class="menu-link load-page" data-page="dashboard_sam" data-title="Dashboard">
        ...
        <?php if ($role === 'ADMINISTRATOR' || $role === 'GA' || $role === 'AUDITOR'): ?>
            <li class="menu-item">
        ...
        <?php if ($role === 'ADMINISTRATOR' || $role === 'AUDITOR'): ?>
            <li class="menu-item">
