...
$routes->group('/', function ($routes) {
    $routes->get('dashboard_sam', 'PagesController::main');
...
$routes->get('getPendingRequestCount', 'RequestItemsController::getPendingRequestCount');
...
$routes->group('dri_maintenance', static function ($routes) {
    ...
    $routes->get('getDepartmentsForDropdown', 'DriController::getDepartmentsForDropdown');
});
...
$routes->group('corrective_action', static function ($routes) {
    ...
    $routes->get('getFeedbackActivity', 'CorrectiveActionController::getFeedbackActivity');
});
...
$routes->group('checksheet', static function ($routes) {
    ...
    $routes->get('getDepartmentsForDropdown', 'DivisionController::getDepartmentsForDropdown');
    $routes->POST('approveItems', 'CheckSheetController::approveItems');
    $routes->post('submitFeedback', 'CheckSheetController::submitFeedback'); 
});
...
$routes->group('dashboard', static function ($routes) {
    ...
    $routes->get('get_monthly_ng_count', 'DashboardController::getMonthlyNgCount');
});

$routes->group('inbox', static function ($routes) {
    $routes->get('getHoldActivity', 'InboxController::getHoldActivity');
    $routes->GET('getPendingRequests', 'RequestItemsController::getPendingRequests');
    $routes->get('get-for-approval/(:num)', 'RequestItemsController::getRequestForApproval/$1');
    $routes->post('updateRequestStatus', 'RequestItemsController::updateRequestStatus');
    // ✅ FIXED: Removed extra '/$2' placeholder
    $routes->get('getCompleteActivityDetails/(:num)', 'InboxController::getCompleteActivityDetails/$1');
});
